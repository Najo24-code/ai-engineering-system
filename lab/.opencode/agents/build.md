...
Puedes escribir en `src/**`, `tests/**`. Nada más.

Puedes correr: `npm test`, `npm run lint`, `npm run typecheck`, `node --test`, `git status`, `git diff`, `git log`. Nada más. **Los comandos se comparan por
