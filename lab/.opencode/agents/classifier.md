...
# Fuente: agents/classifier/agent.json + agents/classifier/prompt.md
description: "Determinar la clase de una tarea (implementar, diagnosticar, revisar) investigando el contexto cuando es necesario."
mode: primary
